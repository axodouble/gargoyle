...
- Full slashcommand support
- Textcommands
- Context commands
- Responses to interactions
- Modular expansion via API endpoints per command
...
- Maintained by [@ceraia](https://github.com/ceraia)

---

_Gargoyle is built for flexibility, extensibility, and performance._
